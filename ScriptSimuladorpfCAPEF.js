$(document).ready(function(){
    ...
    $("#calcular").click(function(){
        ...
        if($("#tempoinvestimento").val() < somabeneficiotemporario ){ 
            alert('O tempo de investimento precisa necessariamente ser maior do que a soma de prazo para benefÃ­cio temporÃ¡rio + tempo de recebimento do benefÃ­cio temporÃ¡rio.'); 
...
//            alert("Why do you want to test me with zeros?");
    ...
    $("#prazoresgate").on('change', function() {
        if(!avisouresgate){
            alert('A opÃ§Ã£o pelo Resgate Total implica na cessaÃ§Ã£o dos demais benefÃ­cios do Plano, bem como no seu desligamento.');
            avisouresgate = true;
        }
    });
    ...
    function printaMeses(meses){
        ...
        celulaBeneficioTemporario.textContent = "BenefÃ­cio TemporÃ¡rio";
        celulaSaldoPlanoFamilia2.textContent = "Saldo Plano FamÃ­lia";
